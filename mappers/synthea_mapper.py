...
class SyntheaETLPipeline(BaseETLPipeline):
    def __init__(self):
        ...
        self.etl_mapping = {
            ...
            "person_": (Person, LoadPerson, ['person_id', 'gender_concept_id', 'year_of_birth', 'month_of_birth', 'day_of_birth', 'birth_datetime', 'race_concept_id', 'ethnicity_concept_id', 'location_id', 'provider_id', 'care_site_id', 'person_source_value', 'gender_source_value', 'gender_source_concept_id', 'race_source_value', 'race_source_concept_id', 'ethnicity_source_value', 'ethnicity_source_concept_id', 'location_source_value']),
            ...
            "visit_detail_": (VisitDetail, LoadVisitDetails, ['visit_detail_id', 'person_source_value', 'visit_detail_concept_id', 'visit_detail_source_concept_id', 'visit_detail_start_date', 'visit_detail_start_datetime', 'visit_detail_end_date', 'visit_detail_end_datetime', 'visit_source_value', 'provider_source_value', 'visit_detail_type_concept_id', 'care_site_source_value',
                                                             'admitted_from_concept_id', 'admitted_from_source_value', 'visit_detail_source_value']),
            ...
            "measurement_": (ObserMeasurement, LoadMeasurement, ['measurement_id', 'person_source_value', 'measurement_datetime', 'measurement_date', 'measurement_type_concept_id', 'measurement_source_value', 'measurement_source_concept_id', 'measurement_concept_id', 'value_as_number', 'value_source_value', 'visit_source_value', 'unit_source_value']),
            "observation_": (Observation, LoadObservation, ['observation_id', 'person_source_value', 'observation_datetime', 'observation_date', 'observation_type_concept_id', 'observation_source_value', 'observation_source_concept_id', 'observation_concept_id', 'visit_source_value', 'value_as_number', 'value_source_value', 'unit_source_value']),
        }
